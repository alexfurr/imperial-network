...
class TCPDF {
	...
	var $text_rgb = hex2RGB( $text_hex );
	var $link_rgb = hex2RGB( $link_hex );
	
	//display creation date
	var $utsNow = strtotime('now');
	var $displayDate = date( 'jS F Y', $utsNow );
	
	//header / front page info
	var $siteURL = get_bloginfo('url');
	var $siteTitle = get_bloginfo( 'name', 'raw' );
